...
class LocationSearchTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let new_location = Location(clock_position: locations.count+1, name: "Test", region: CLCircularRegion(center: placemark.coordinate, radius: regionRadius, identifier: "Testtt"))
